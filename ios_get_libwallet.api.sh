...
# 3 header files required by Blood Donation Coin are missing from the IOS SDK. I copied them from iphoneSimulator SDK
...
rm -r blooddonationcoin/build > /dev/null
mkdir -p blooddonationcoin/build/release
pushd blooddonationcoin/build/release
